...
EnterSwarmCommand createDefaultControlInfo(
        ...
        IPv4Address const& trackerAddress, int trackerPort) {
...
void ClientController::initialize(int stage) {
    if (stage == 0) {
        ...
        IPv4Address trackerAddress = L3AddressResolver().resolve(sTrackerAddress.c_str(), L3AddressResolver::ADDR_IPv4);
